#pragma once
// ─────────────────────────────────────────────────────────────────────────────
// capture — one-click PNG of the visible rack.
//
// Uses glReadPixels off the GL front buffer, so the output is the exact
// pixels that were on screen when you clicked. High-DPI native (retina
// displays save at physical pixel resolution).
//
// Files: <prefix><NN>.png, same auto-indexing / output-dir conventions as
// grab and take.
// ─────────────────────────────────────────────────────────────────────────────
